...
function sumar(){
    ...
    document.getElementById("texto_arriba").innerHTML = document.getElementById("display").innerHTML + " + ";
    document.getElementById("operacion").innerHTML = "+";
    document.getElementById("display").innerHTML = "";
}
...
function multiplicar(){
    ...
    document.getElementById("texto_arriba").innerHTML = document.getElementById("display").innerHTML + " x ";
...
function obtenerResultado(){
    n2 = Number(document.getElementById("display").textContent);
    document.getElementById("texto_arriba").innerHTML = document.getElementById("texto_arriba").innerHTML + n2;
    realizarOperacion();    
