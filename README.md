...
2.	Se creó una instancia de esta clase. El primer argumento es el nombre del módulo de la aplicación o el paquete. Si se importa como aplicación será __ name __ , si es un módulo será __ main __
